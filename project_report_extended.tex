...
algorithm receiving $N$ evenly spaced revelations can achieve worst-case
regret $R$ unless
\begin{equation}
...
\Cref{eq:ncalls} up to a constant. Free batching therefore extends up to
$\Theta(T^{1/3})$ reports and no further. Finally, \Cref{thm:block} is
sublinear in $T$ iff $n\Kmax^{4/3}\log^{1/3}(n\Kmax)=o(T^{1/3})$ and
