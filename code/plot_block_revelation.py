...
Produces `figures/block_revelation.{pdf,png}`:
  ...
  (a) cumulative regret at n = 10 against the C t^{2/3} envelope of Theorem 18;
  (b) the same at n = 20;
  (c) final regret as a function of the revelation granularity B, whose
      worst-case growth is the 2 K' B additive term of Theorem 18;
